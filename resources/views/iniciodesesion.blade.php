...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <img src="img/logo ledev.png" alt="SmartAdmin"> </span>
			</div>

			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Necesitas una cuenta?</span> <a href="{{ url('/registro') }}" class="btn btn-danger">Crear cuenta</a> </span>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<img src="img/demo/img login.jpg" class="ImagenLoginPos" class="pull-right display-image" alt="">
								...
								<fieldset>
									...
									<section>
										<label class="checkbox">
											...
											<i></i>Mantener Sesión iniciada</label>
									</section>
								</fieldset>
								<footer>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$("#login-form").validate({
					...
					messages : {
						email : {
							required : 'Por favor ingresa tu correo electónico',
							email : 'Por favor ingresa un correo electónico valido'
						},
						password : {
