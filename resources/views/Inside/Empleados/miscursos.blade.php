			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-book"></i> Mis Cursos </h1>
					</div>
				</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				*/	
			    ...
			    // custom toolbar
			    $("div.toolbar").html('<div class="text-right"><span><a class="btn btn-primary posboton" href="file:///C:/xampp/htdocs/LearningDeveloperPM%20-%20Empleados/DEVELOPER/HTML_Full_Version_v1.8.2/agregarcursos.html">Agregar Curso</a></span> <img src="img/logo ledev.png" alt="LearningDeveloper" style="width: 111px; margin-top: 4px; margin-right: 10px;"></div>');
