	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Menú</li><li>Administración de Salas</li>
				</ol>
				<!-- end breadcrumb -->
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-folder-open"></i> Administración de Salas</h1>
					</div>
				</div>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false">
								...
								<header>
									...
									<h2>Calendario día 05 de mayo 2018 </h2>
									...
									<div class="widget-body no-padding">
										...
										<table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
											...
											<tr>
												...
												<td>6 personas</td>
												<td><span class="center-block padding-5 label label-warning">Ocupado</span></td>
											</tr>
											<tr>
												<td>102</td>
												<td>C</td>
											...
											<tr>
												...
												<td>20 personas</td>
												<td><span class="center-block padding-5 label label-default">Reparación</span></td>
											</tr>
											<tr>
												<td>200</td>
												<td>J</td>
											...
											<tr>
												...
												<td>10 personas</td>
												<td><span class="center-block padding-5 label label-danger">Cancelado</span></td>
											</tr>
											<tr>
												<td>200</td>
												<td>N</td>
