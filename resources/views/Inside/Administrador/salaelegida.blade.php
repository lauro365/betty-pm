		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="inicioadmin/logout" title="Cerrar Sesión" data-action="" data-logout-msg="Seguro que quieres salir?"><i class="fa fa-sign-out"></i></a> </span>				<!-- end logout button -->
