		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="{{ url('/') }}" title="Cerrar Sesión" data-action="{{ action('inicioadminController@logout') }}" data-logout-msg="Seguro que quieres salir?"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				jQuery("#jqgrid").jqGrid({
					...
					datatype : "local",
					height : 'auto',
					colNames : ['Acción', 'Curso', 'Creado', 'Instructor', 'Precio', 'Capacidad', 'Duración', 'Notas sobre el Curso'],
					colModel : [{
						name : 'act',
						index : 'act',
						sortable : false
